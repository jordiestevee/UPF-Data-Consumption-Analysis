...
#
#
selected_daily_median= magnitud_activa_per_UPF_per_hora_Poblenou$la_magnitud_activa_entrante
selected_day_type = calendari_corregit$tipus_dia
selected_date = magnitud_activa_per_UPF_per_hora_Poblenou$la_data
for_box_plot_UPF_per_hora_Poblenou <- data.frame(
	the_date =selected_date,
	daily_median=as.numeric(selected_daily_median),
	day_type=selected_day_type
)
#
boxplot(daily_median~day_type,data=for_box_plot_UPF_per_hora_Poblenou, main="Poblenou, tipus de dia",
	col=calendar_colors,
        names= factor_names,
